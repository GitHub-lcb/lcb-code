<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="图片路径" prop="icon">
        <el-input
...
<!--      <el-table-column label="是否中奖" align="center" prop="isPrize" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="图片路径" prop="icon">
          <el-input v-model="form.icon" placeholder="请输入图片路径" />
        </el-form-item>
        <el-form-item label="物品名" prop="name">
          <el-input v-model="form.name" placeholder="请输入物品名" />
        </el-form-item>
        <el-form-item label="物品编号" prop="num">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除物品编号为"' + ids + '"的数据项?', "警告", {
